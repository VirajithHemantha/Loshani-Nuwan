  ...
  return (
    <section className="relative min-h-screen py-24 sm:py-32 flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 bg-brand-ivory overflow-hidden">
        <video
          src="/give_beautiful_live_video_202604291917.mp4"
          autoPlay
          muted
          loop
          playsInline
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          ...
          <span className="text-stone-900 uppercase tracking-[0.6em] text-xs sm:text-sm font-bold mb-10 block drop-shadow-sm font-sans">
          ...
          <div className="relative mb-12 w-full flex justify-center">
            <h1 className="relative text-6xl sm:text-8xl lg:text-9xl font-display text-stone-800 leading-tight drop-shadow-sm">
              Loshani <br className="sm:hidden" />
              <span className="text-stone-900 italic font-light mx-4 sm:mx-8 text-5xl sm:text-7xl lg:text-8xl inline-block -translate-y-2 sm:-translate-y-4">&</span>
