          ...
          <div className="lg:w-1/2 relative z-10 w-full">
            ...
            >
              ...
              <h2 className="text-5xl sm:text-6xl lg:text-7xl font-display text-stone-800 mb-8 leading-[1.1] drop-shadow-sm">
                Wedding <span className="italic font-light text-poruwa-primary">Reception</span>
              </h2>

              <p className="text-stone-500/90 font-serif text-lg sm:text-xl leading-relaxed mb-16 max-w-lg">
                A beautiful afternoon of dining, blessings, and celebration following our wedding ceremony, starting from 11:00 AM onwards.
              ...
              <div className="relative space-y-10 ml-10 sm:ml-12 border-l-[1.5px] border-poruwa-primary/40 pl-10 sm:pl-12 py-4">
                ...
                <div className="relative group">
                  ...
                  <div>
                    <h4 className="font-serif text-2xl sm:text-3xl text-stone-800 mb-1 group-hover:text-poruwa-primary transition-colors duration-500">Saturday, September 19, 2026</h4>
                    <p className="text-stone-500/80 text-[10px] sm:text-[11px] uppercase tracking-[0.2em] font-bold">Jetwing Blue Negombo</p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div>
                    <h4 className="font-serif text-xl sm:text-2xl text-stone-800 mb-1 group-hover:text-poruwa-primary transition-colors duration-500">11:00 AM</h4>
                ...
                <div className="relative group">
                  ...
                  <div>
                    <h4 className="font-serif text-xl sm:text-2xl text-stone-800 mb-1 group-hover:text-poruwa-primary transition-colors duration-500">11:30 AM</h4>
                    <p className="text-stone-500/80 text-[10px] sm:text-[11px] uppercase tracking-[0.2em] font-bold">Couple's Grand Entrance</p>
                  </div>
                </div>
